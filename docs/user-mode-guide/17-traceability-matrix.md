...
| R02 Goal/context | F02 Task creation | POST /tasks; GuideTask/GuideSession | UX02 | SEC-01/07 | T02 | 1 |
...
| R05 Confirmed plan | F05 Planning | POST /tasks/{task_id}/plans; PATCH plan; POST plan confirmations; TaskPlan/TaskStep | UX04 | SEC-07/08 | T05 | 2 |
| R06 Optional screen access | F06 Startup | POST session start/permissions/decisions/captures; ScreenObservationPermission/CaptureIntent | UX05/UX10 | SEC-03/06 | T06/T20/A05 | 1 manual, 4 live |
| R07 Native pointer/dot | F07 Overlay | GET current instruction; Instruction.pointer | UX06/UX14 | SEC-03/15 | T07/T21 | 3/4 |
| R08 One instruction | F08 Display | POST /sessions/{session_id}/instructions; Instruction | UX06 | SEC-07/09 | T08/A02 | 2/3 |
| R09 Evidence verification | F09 Claim/check | POST completion-claims/verifications; CompletionClaim/VerificationResult | UX06/UX09 | SEC-05/09 | T09/A01/A10 | 2/4 |
| R10 Adapt/correct | F10 Recheck/revision | POST feedback/retries; UserFeedback/VerificationResult | UX08 | SEC-05/09 | T10/A06 | 2/4 |
| R11 Pause/emergency | F11 Pause | POST pause; Permission/Session.control_epoch | UX07 | SEC-03/05/12 | T11/T32/A03 | 2 base, 4 live, 5 recovery |
| R12 Stop/terminate | F12 Stop | POST stop; GuideSession/SessionSummary | UX09/UX14 | SEC-05/12/15 | T12/A04 | 2/3/4 |
...
| R14 History/summary/feedback | F14 History | GET sessions/summary; POST feedback; SessionSummary/UserFeedback | UX09/UX11 | SEC-01/04/13 | T14/A10 | 2/5 |
...
| R17 Scope/risk | F17 App/safety gate | Permission/TaskStep.policy_disposition | UX05/UX08/UX13 | SEC-06/07/08 | T17/T29/A08 | 1/2/4 |
| R18 Injection resistance | F18 Untrusted evidence | Analysis/Instruction schemas; SafetyEvent | UX08 | SEC-09/10/14 | T18/T31 | 1 then every provider change |
| R19 Service boundaries | F19 Backend mediation | Versioned API; Operation; architecture 06 | UX01/UX14 | SEC-01/10/11/15 | T19/T28 | 0/1/3 |
| R20 State integrity | F20 State control | GuideSession/Operation/GuidanceEvent; GET events | UX06/UX07/UX08 | SEC-05/12/13 | T20/T33/T37 | 1 base, 2 full, 4 events |
...
| R23 Cost/abuse/observability | F23 Budgets | Rate profiles; Operation/SafetyEvent | UX08 | SEC-10/13/14 | T23/T38 | 1 then every phase |
...
| R28 Verification strategy | F28 Testability | OpenAPI/entity schemas/test adapters | UX01–UX14 acceptance | SEC-01–SEC-16 | T01–T40/A01–A10 | All phase gates |
...
All 30 R IDs have F/API-or-entity/UX/SEC/T/phase mappings. T31–T40 supplement row-specific tests for grounding, timing, crashes, deletion, devices, event streaming, performance, usability and full release flow. A01–A10 are the ten required acceptance scenarios. Internal roles map through R18/R19/R20/R26, and every taxonomy row inherits one verifier/failure profile in 10 plus SEC-06/07/08. Each ADR states related R IDs and revisit conditions.
